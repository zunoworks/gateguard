...
DEFAULT_EDIT = (
    ...
    "3. If this file reads/writes data files, cat one real record and "
    "show the actual field names, structure, and date format.\n"
...
DEFAULT_WRITE = (
    ...
    "3. If this file will read/write data files, cat one real record and "
    "show the actual field names, structure, and date format.\n"
    "4. Quote the user's current instruction verbatim.\n\n"
    "Present the facts, then retry the same operation."
)
